      ...
      >
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-zinc-400">
            Handcrafted designer frames designed to combine optimal visual
            clarity with modern elegance.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="group relative overflow-hidden rounded-2xl border border-zinc-900 bg-zinc-900/25 p-8 transition-all duration-300 hover:border-zinc-800 hover:bg-zinc-900/40">
            ...
            <p className="text-zinc-400 text-sm leading-relaxed mb-6">
              Timeless frames engineered for daily comfort and visual precision.
              Elegant profiles for the modern professional.
            </p>
          ...
          <div className="group relative overflow-hidden rounded-2xl border border-zinc-900 bg-zinc-900/25 p-8 transition-all duration-300 hover:border-zinc-800 hover:bg-zinc-900/40">
            ...
            <p className="text-zinc-400 text-sm leading-relaxed mb-6">
              Advanced polarized lenses with full UV blocking. Crafted for
              open-air adventures and bright city days.
            </p>
          ...
          <div className="group relative overflow-hidden rounded-2xl border border-zinc-900 bg-zinc-900/25 p-8 transition-all duration-300 hover:border-zinc-800 hover:bg-zinc-900/40">
            ...
            <p className="text-zinc-400 text-sm leading-relaxed mb-6">
              Ultra-lightweight titanium and rimless frames. Subtle designs that
              maximize view and emphasize your features.
            </p>
